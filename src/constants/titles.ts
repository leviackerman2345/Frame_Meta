...
const newReleasesHeading = {
  title: "New Releases",
  subtitle: "Fresh to your screens",
} as const;

const newReleasesThisWeek = [
...
export const titlesContent = {
  featuredMovies: {
    heading: featuredMoviesHeading,
    items: featuredMovies,
  },
  featuredSeries: {
    heading: featuredSeriesHeading,
  ...
  top10Movies: {
    heading: top10MoviesHeading,
    items: top10Movies,
  },
  top10Series: {
    heading: top10SeriesHeading,
    items: top10Series,
  },
  newReleases: {
    heading: newReleasesHeading,
    thisWeek: newReleasesThisWeek,
    thisMonth: newReleasesThisMonth,
  },
  inCinema: {
    heading: inCinemaHeading,
  },
  asianSpotlight: {
    heading: asianSpotlightHeading,
    countries: asianSpotlightCountries,
    korean: asianSpotlightKorean,
    japanese: asianSpotlightJapanese,
  },
  comingSoon: {
    heading: comingSoonHeading,
    items: comingSoonData,
  },
} as const;
