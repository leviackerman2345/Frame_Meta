...
export function ArtistFilmography({ movieCredits, tvCredits }: ArtistFilmographyProps) {
  ...
  return (
    <section className="w-full max-w-360 mx-auto px-6 md:px-12 py-10 md:py-20 flex flex-col gap-12 overflow-hidden md:overflow-visible" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
