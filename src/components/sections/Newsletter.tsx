...
export function Newsletter() {
  return (
    <section id="newsletter" className="relative w-full bg-black py-24 md:py-32 overflow-hidden border-t border-white/[0.05]">
      ...
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-zinc-800/[0.1] rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
        <div className="bg-zinc-900/40 backdrop-blur-2xl border border-white/[0.08] rounded-[32px] md:rounded-[48px] p-8 md:p-16 lg:p-20 overflow-hidden relative">
          
          {/* Subtle inner glow */}
          <div className="absolute -top-24 -right-24 w-64 h-64 bg-white/[0.02] rounded-full blur-[60px]" />
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              >
                ...
                >
                  <span className="relative z-10">{newsletterContent.buttonText}</span>
                  ...
                  {/* Button shine effect */}
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-black/5 to-transparent -translate-x-full group-hover:animate-shine" />
                </button>
              </form>
